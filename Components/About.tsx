        ...
        mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-[2rem]'>
                <div>
                    ...
                    <div className='mt-[2rem] space-y-3'>
                        ...
                        <div data-aos='zoom-in' data-aos-anchor-placement='top-center' data-aos-delay="400" className='flex items-center space-x-4'>
                            <CheckIcon className='w-[2rem] h-[2rem] text-yellow-600' />
                            <p className='text-[18px] text-white'>Web Development</p>
                        </div>
                        <div data-aos='zoom-in' data-aos-anchor-placement='top-center' data-aos-delay="600" className='flex items-center space-x-4'>
                            <CheckIcon className='w-[2rem] h-[2rem] text-yellow-600' />
