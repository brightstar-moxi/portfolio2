                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-[3rem] items-center'>
                    <div>
                        ...
                        <div className='mt-[2rem] flex items-center space-x-6'>
                            <button className='relation flex h-[50px] w-40 items-center justify-center font-semibold
                             overflow-hidden bg-red-500 text-white shadow-2xl transition-all before:absolute before:h-0 
                             before:w-0 before:rounded-full before:bg-blue-600 before:duration-500 before:ease-out hover:before:h-56 hover:before:w-56'>
